        ...
        <div class="row">
            <div class="col-12">
                <div class="wpo-breadcumb-wrap">
                    <h2>Göynük Kanyonu</h2>
                    <ul>
                        <li><a href="index">Anasayfa</a></li>
                        <li><span>Göynük Kanyonu</span></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="wpo-destination-single-wrap">
                    <div class="wpo-destination-single-content">
                        <img src="assets/images/destination/goynuk-kanyonu-buyuk.jpg" alt="">
                        <div class="wpo-destination-single-content-des">
                            <h2>Göynük Kanyonu</h2>
                            <p>Muhteşem bir manzaraya sahip, farklı aktiviteler yapabileceğiniz, büyüklü küçüklü şelalelerin sesinde farklı bir müzik tınısına kulak verip ruhunuzu dinleyeceğiniz bir yere yolcuk yapmak ister misiniz? <br><br>

                                Böyle bir düş kurmak kolaydır fakat anlatıldığı gibi bir yer bulmak zor diyebilirsiniz. Aslında haksızda sayılmazsınız. Tabii Göynük Kanyonu'na hiç gitmediyseniz…. <br><br>

                                Göynük kanyonu, tam da harika bir tatil geçirebileceğiniz Antalya'nın Kemer ilçesindedir. Herkes tarafından bilinmez kanyon. Aslında son yıllarda duyanların muhakkak gittiği bir yer olmasında bunun katkısı var. Çevresinde bulundurduğu büfe ve restoranlar damağınıza lezzetli tatlar bırakacak. Gidilecek yerler arasında değildir Göynük Kanyonu, kesinlikle gidilmeli.
