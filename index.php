                                    ...
                                    <div class="tourist-group-wrap">
                                        <div class="tourist-inner">
                                            ...
                                            <ul>
                                                ...
                                                <li><input disabled type="text" id="children" value="0"> Children
                                                </li>
            ...
            <div class="row">
                ...
                <div class="col col-lg-4 col-md-6 col-12">
                    <div class="wpo-pricing-item">
                        <div class="wpo-pricing-top">
                            <div class="wpo-pricing-img">
                                <img src="assets/images/pricing/2.jpg" alt="">
                            </div>
                            <div class="wpo-pricing-text">
                                <h4>Modern Room</h4>
...
<footer class="wpo-site-footer">
                ...
                <div class="col col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="widget wpo-service-link-widget">
                        ...
                        <div class="contact-ft">
                            <ul>
                                <li><i class="fi flaticon-placeholder"></i>7 Green Lake Street Crawfordsville, IN 47933
                                </li>
    ...
    <div class="wpo-lower-footer">
        <div class="container">
            <div class="row">
                <div class="col col-xs-12">
                    <p class="copyright"> Copyright &copy; 2021 Parador by <a href="index.html">wpOceans</a>. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
